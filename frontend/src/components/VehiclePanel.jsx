...
const VehiclePanel = ({setVehiclePannel , setConfirmRidePannel}) => {
  return (
    <div>
        <h5 className='p-1 text-center w-[93%] absolute top-0' onClick={() => setVehiclePannel(false)}><i className='text-3xl text-gray-200 ri-arrow-down-wide-line'></i></h5>
        <h3 className='text-2xl font-semibold mb-5'>Choose a Vehicle</h3>
        <div onClick={() => setConfirmRidePannel(true)} className='flex border-2 active:border-black mb-2 rounded-xl p-3 items-center justify-between w-full'>
